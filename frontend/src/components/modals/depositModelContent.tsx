...
const DepositModalContent: React.FC<{ onSubmit: (amount: number) => void }> = ({ onSubmit }) => {
  ...
  return (
    <div className="p-6 text-center bg-zinc-800">
      <h2 className="text-xl font-semibold mb-4 text-white">Deposit Funds</h2>
      <p className="text-white mb-6">Enter the amount you want to deposit:</p>
      <input
        type="number"
        className="w-full text-white px-4 py-2 border bg-zinc-700 rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
